...
export function NovenaKepadaHatiKudusYesusPrayer() {
  const t = useTranslations("prayers.novena-kepada-hati-kudus-yesus");
  ...
  const handleClick = () => {
    startTransition(async () => {
      const res = await trackUserPrayer(`novena-kepada-hati-kudus-yesus`);
      if (!res.success) {
        if (res.redirectTo) {
  ...
  const generateSteps = (): PrayerStep[] => {
